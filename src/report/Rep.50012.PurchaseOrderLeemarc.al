report 50012 "Purchase Order Leemarc"
{
    RDLCLayout = './PurchaseOrderLeemarc.rdl';
    WordLayout = './PurchaseOrderLeemarc.docx';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                column(Desc_2_PurchLine; "Description 2")
                {

                }
                column(DescLeemarc; Description + ' ' + "Description 2")
                {

                }
                column(Color_Code; "LEE_Color Code")
                {
