report 50017 "Sales Invoice Leemarc"
{
    RDLCLayout = './SalesInvoiceLeemarc.rdl';
    WordLayout = './SalesInvoiceLeemarc.docx';
    Caption = 'Sales Invoice Leemarc';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                column(Color_Code; ColorDescription)
                {
                ...
                column(Embellishment; EmbeDescription)
                {
                ...
                column(Description_Line; Description + ' ' + "Description 2")
                {
                }
                ...
                begin
                    ...
                    clear(EmbeDescription);
                    if "No." <> '' then begin
                        if ItemEmbellishment.Get(LEE_Embellishment) then
                            EmbeDescription := ItemEmbellishment.Descripton;
                    end;
                    clear(ColorDescription);
                    if "No." <> '' then begin
                        if ItemColor.Get("LEE_Color Code") then
                            ColorDescription := ItemColor.Description;
                    end;
                    ...
                    InvDiscAmount += "Line Discount Amount";
            ...
            dataitem(Totals; "Integer")
            {
                ...
                column(TotalInvoiceDiscountAmount; InvDiscAmount)
                {
                    AutoFormatExpression = Header."Currency Code";
                    AutoFormatType = 1;
                }
            ...
            dataitem("Sales Comment Line"; "Sales Comment Line")
            {
                ...
                column(CommentText1; CommentText1)
                {
                }
            }
    ...
    var
        ...
        ColorDescription: Text[200];
        EmbeDescription: Text[200];
        ItemEmbellishment: Record LEE_Embellishment;
