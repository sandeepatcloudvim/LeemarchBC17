report 50010 "Sales Order Conf. Leemarc"
{
    RDLCLayout = './SalesOrderConfLeemarc.rdlc';
    WordLayout = './SalesOrderConfLeemarc.docx';
        ...
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                begin
                    ...
                    if (Type = Type::Item) and (Quantity >= 1) then
    ...
    var
        ...
        ColorCode: Record LEE_Color;
        SizeCode: Record LEE_Size;
